...
class Menu(tools._State):
    ...
    def reset_game_info(self, deep_mode=False):
        ...
        if deep_mode==True:
            self.game_info[c.LIVES] = 100000
        self.persist = self.game_info

    def skip_setup(self):
        """Skip main menu, go to load screen"""
        self.reset_game_info(self.deep_mode)
        self.done = True
